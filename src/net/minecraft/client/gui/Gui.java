...
public class Gui {
    ...
    public void drawGradientRect2(float x, float y, float width, float height, int startColor, int endColor) {
        float f = (float) (startColor >> 24 & 255) / 255.0F;
        float f1 = (float) (startColor >> 16 & 255) / 255.0F;
        float f2 = (float) (startColor >> 8 & 255) / 255.0F;
        float f3 = (float) (startColor & 255) / 255.0F;
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
        worldrenderer.pos(x + width, y, this.zLevel).color(f1, f2, f3, f).endVertex();
        worldrenderer.pos(x, y, this.zLevel).color(f1, f2, f3, f).endVertex();
        worldrenderer.pos(x, y + height, this.zLevel).color(f5, f6, f7, f4).endVertex();
        worldrenderer.pos(x + width, y + height, this.zLevel).color(f5, f6, f7, f4).endVertex();
        tessellator.draw();
        GlStateManager.shadeModel(7424);
        GlStateManager.disableBlend();
        GlStateManager.enableAlpha();
