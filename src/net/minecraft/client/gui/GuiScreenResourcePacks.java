...
public class GuiScreenResourcePacks extends GuiScreen {
   ...
   /* The first pack list. */
   private List<ResourcePackListEntry> initialSelectedEntries;
   ...
   public void initGui() {
	  ...
	  this.buttonList
			.add(new GuiOptionButton(1, this.width / 2 + 4, this.height - 48, I18n.format("gui.done", new Object[0])));
	  if (!this.changed) {
		 ...
		 async((u) -> { resourcepackrepository.updateRepositoryEntriesAll(); });
	  ...
	  this.searchBar = new GuiTextField(2173, fontRendererObj, width / 2 - 50, 6, 100, 20);
   }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
	  ...
	  if (availableResourcePacksList != null) {
		 this.availableResourcePacksList.drawScreen(mouseX, mouseY, partialTicks);
	  }
	  if (selectedResourcePacksList != null) {
