...
public class RenderGuardian extends RenderLiving<EntityGuardian> {
	  ...
	  if (super.shouldRender(livingEntity, camera, camX, camY, camZ)) {
		 ...
		 if (livingEntity.hasTargetedEntity()) {
			...
			if (entitylivingbase != null) {
			   ...
			   if (camera.isBoundingBoxInFrustum(AxisAlignedBB.fromBounds(vec31.xCoord, vec31.yCoord, vec31.zCoord,
   ...
   private Vec3 func_177110_a(EntityLivingBase entityLivingBaseIn, double p_177110_2_, float p_177110_4_) {
	  double d0 = entityLivingBaseIn.lastTickPosX
			+ (entityLivingBaseIn.posX - entityLivingBaseIn.lastTickPosX) * (double) p_177110_4_;
	  double d1 = p_177110_2_ + entityLivingBaseIn.lastTickPosY
			+ (entityLivingBaseIn.posY - entityLivingBaseIn.lastTickPosY) * (double) p_177110_4_;
	  double d2 = entityLivingBaseIn.lastTickPosZ
			+ (entityLivingBaseIn.posZ - entityLivingBaseIn.lastTickPosZ) * (double) p_177110_4_;
   ...
   public void doRender(EntityGuardian entity, double x, double y, double z, float entityYaw, float partialTicks) {
	  ...
	  if (entitylivingbase != null) {
		 ...
		 double d3 = d2 * 1.41D;
		 double d4 = 0.0D + MathHelper.cos(d1 + 2.356194490192345D) * d3;
		 double d5 = 0.0D + MathHelper.sin(d1 + 2.356194490192345D) * d3;
		 double d6 = 0.0D + MathHelper.cos(d1 + (Math.PI / 4D)) * d3;
		 double d7 = 0.0D + MathHelper.sin(d1 + (Math.PI / 4D)) * d3;
		 double d8 = 0.0D + MathHelper.cos(d1 + 3.9269908169872414D) * d3;
		 double d9 = 0.0D + MathHelper.sin(d1 + 3.9269908169872414D) * d3;
		 double d10 = 0.0D + MathHelper.cos(d1 + 5.497787143782138D) * d3;
		 double d11 = 0.0D + MathHelper.sin(d1 + 5.497787143782138D) * d3;
		 double d12 = 0.0D + MathHelper.cos(d1 + Math.PI) * d2;
		 double d13 = 0.0D + MathHelper.sin(d1 + Math.PI) * d2;
		 double d14 = 0.0D + MathHelper.cos(d1 + 0.0D) * d2;
		 double d15 = 0.0D + MathHelper.sin(d1 + 0.0D) * d2;
		 double d16 = 0.0D + MathHelper.cos(d1 + (Math.PI / 2D)) * d2;
		 double d17 = 0.0D + MathHelper.sin(d1 + (Math.PI / 2D)) * d2;
		 double d18 = 0.0D + MathHelper.cos(d1 + (Math.PI * 3D / 2D)) * d2;
		 double d19 = 0.0D + MathHelper.sin(d1 + (Math.PI * 3D / 2D)) * d2;
		 double d20 = 0.0D;
		 double d21 = 0.4999D;
