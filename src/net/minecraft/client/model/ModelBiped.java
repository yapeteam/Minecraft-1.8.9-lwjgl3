...
public class ModelBiped extends ModelBase {
	...
	/**
	 * Records whether the model should be rendered holding an item in the left hand, and if that item
	 * is a block.
	 */
	public int heldItemLeft;
	/**
	 * Records whether the model should be rendered holding an item in the right hand, and if that item
	 * is a block.
	 */
	...
	public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
		...
		if (this.heldItemLeft != 0) this.bipedLeftArm.rotateAngleX = this.bipedLeftArm.rotateAngleX * 0.5F - ((float) Math.PI / 10F) * this.heldItemLeft;
		...
		case 3:
			this.bipedRightArm.rotateAngleX = this.bipedRightArm.rotateAngleX * 0.5F - ((float) Math.PI / 10F) * this.heldItemRight;
			if (!oldAnimations) this.bipedRightArm.rotateAngleY = -0.5235988F;
		}
		...
		if (this.swingProgress > -9990.0F) {
			...
			this.bipedRightArm.rotateAngleX = (float) (this.bipedRightArm.rotateAngleX - (f1 * 1.2D + f2));
	...
	public void postRenderArm(final float scale) { this.bipedRightArm.postRender(scale); }
}
