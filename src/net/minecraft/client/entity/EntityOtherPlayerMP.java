...
public class EntityOtherPlayerMP extends AbstractClientPlayer {
	 ...
	 */
	@Override
	public boolean attackEntityFrom(final DamageSource source, final float amount) { return true; }
	 ...
	 */
	@Override
	public void addChatMessage(final IChatComponent component) { Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(component); }

	/**
	 * Returns {@code true} if the CommandSender is allowed to execute the command, {@code false} if not
	 */
	@Override
	public boolean canCommandSenderUseCommand(final int permLevel, final String commandName) { return false; }
