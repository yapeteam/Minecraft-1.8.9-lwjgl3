...
public class Village {
   ...
   public void setWorld(World worldIn) { this.worldObj = worldIn; }
   ...
   private Vec3 func_179862_a(BlockPos p_179862_1_, int p_179862_2_, int p_179862_3_, int p_179862_4_) {
	  for (int i = 0; i < 10; ++i) {
		 BlockPos blockpos = p_179862_1_.add(this.worldObj.rand.nextInt(16) - 8, this.worldObj.rand.nextInt(6) - 3,
			   this.worldObj.rand.nextInt(16) - 8);
		 if (this.func_179866_a(blockpos)
			   && this.func_179861_a(new BlockPos(p_179862_2_, p_179862_3_, p_179862_4_), blockpos)) {
   ...
   private void updateNumIronGolems() {
	  List<EntityIronGolem> list = this.worldObj.<EntityIronGolem>getEntitiesWithinAABB(EntityIronGolem.class,
   ...
   public int getVillageRadius() { return this.villageRadius; }
    ...
    */
   public int getNumVillageDoors() { return this.villageDoorInfoList.size(); }

   public int getTicksSinceLastDoorAdding() { return this.tickCounter - this.lastAddDoorTimestamp; }

   public int getNumVillagers() { return this.numVillagers; }

   public boolean func_179866_a(BlockPos pos) {
	  return this.center.distanceSq(pos) < (double) (this.villageRadius * this.villageRadius);
   }

   public List<VillageDoorInfo> getVillageDoorInfoList() { return this.villageDoorInfoList; }
    ...
    */
   public boolean isAnnihilated() { return this.villageDoorInfoList.isEmpty(); }
   ...
   private void updateVillageRadiusAndCenter() {
	  ...
	  if (i == 0) {
		 ...
		 this.villageRadius = Math.max(32, (int) MeowMath.sqrt((double) j) + 1);
	  }
   }
   ...
   public void readVillageDataFromNBT(NBTTagCompound compound) {
	  ...
	  this.centerHelper = new BlockPos(compound.getInteger("ACX"), compound.getInteger("ACY"),
			compound.getInteger("ACZ"));
	  ...
	  for (int i = 0; i < nbttaglist.tagCount(); ++i) {
		 ...
		 VillageDoorInfo villagedoorinfo = new VillageDoorInfo(
			   ...
			   nbttagcompound.getInteger("IDX"), nbttagcompound.getInteger("IDZ"), nbttagcompound.getInteger("TS"));
	  ...
	  for (int j = 0; j < nbttaglist1.tagCount(); ++j) {
		 ...
		 if (nbttagcompound1.hasKey("UUID")) {
			...
			GameProfile gameprofile = playerprofilecache
				  .getProfileByUUID(UUID.fromString(nbttagcompound1.getString("UUID")));
			if (gameprofile != null) {
    ...
    */
   public void endMatingSeason() { this.noBreedTicks = this.tickCounter; }
   ...
   public void setDefaultPlayerReputation(int p_82683_1_) {
	  for (String s : this.playerReputation.keySet()) { this.setReputationForPlayer(s, p_82683_1_); }
   }
