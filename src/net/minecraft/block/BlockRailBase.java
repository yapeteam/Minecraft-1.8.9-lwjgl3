...
public abstract class BlockRailBase extends Block
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        EnumRailDirection blockrailbase$enumraildirection = iblockstate.getBlock() == this ? (EnumRailDirection)iblockstate.getValue(this.getShapeProperty()) : null;
    ...
    public class Rail
    {
        ...
        public Rail(World worldIn, BlockPos pos, IBlockState state)
        {
            ...
            EnumRailDirection blockrailbase$enumraildirection = (EnumRailDirection)state.getValue(BlockRailBase.this.getShapeProperty());
        ...
        private void func_150651_b()
        {
            ...
            {
                Rail blockrailbase$rail = this.findRailAt((BlockPos)this.field_150657_g.get(i));
