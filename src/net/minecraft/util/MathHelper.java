...
public class MathHelper {
	...
	/**
	 * Though it looks like an array, this is really more like a mapping. Key (index of this array) is the upper 5 bits of the result of multiplying a 32-bit unsigned integer by
	 * the B(2, 5) De Bruijn sequence 0x077CB531. Value (value stored in the array) is the unique index (from the right) of the leftmost one-bit in a 32-bit unsigned integer that
	 * can cause the upper 5 bits to get that value. Used for highly optimized "find the log-base-2 of this number" calculations.
	 */
	 ...
	 */
	public static float sin(float p_76126_0_) { return fastMath ? MeowMath.sin(p_76126_0_) : SIN_TABLE_FAST[(int) (p_76126_0_ * radToIndex) & 4095]; }

	public static float sin(double d) { return fastMath ? MeowMath.sin((float) d) : SIN_TABLE_FAST[(int) (d * radToIndex) & 4095]; }

	/**
	 * cos looked up in the sin table with the appropriate offset
	 */
	public static float cos(float value) { return fastMath ? MeowMath.cos(value) : SIN_TABLE_FAST[(int) (value * radToIndex + 1024.0F) & 4095]; }

	public static float cos(double value) { return fastMath ? MeowMath.cos((float) value) : SIN_TABLE_FAST[(int) (value * radToIndex + 1024.0F) & 4095]; }

	public static float sqrt_float(float value) { return (float) MeowMath.sqrt((double) value); }

	public static float sqrt_double(double value) { return (float) MeowMath.sqrt(value); }

	/**
	 * Returns the greatest integer less than or equal to the float argument
	 */
	public static int floor_float(float value) { return MeowMath.floor(value); }

	/**
	 * returns par0 cast as an int, and no greater than Integer.MAX_VALUE-1024
	 */
	public static int truncateDoubleToInt(double value) { return (int) (value + 1024.0D) - 1024; }

	/**
	 * Returns the greatest integer less than or equal to the double argument
	 */
	public static int floor_double(double value) { return MeowMath.floor((float) value); }
	...
	public static int func_154353_e(double value) { return (int) (value >= 0.0D ? value : -value + 1.0D); }
	 ...
	 */
	public static int abs_int(int value) { return value >= 0 ? value : -value; }

	public static int ceiling_float_int(float value) { return MeowMath.ceil(value); }

	public static int ceiling_double_int(double value) { return MeowMath.ceil((float) value); }

	public static int clamp_int(int num, int min, int max) { return MeowMath.clamp(num, min, max); }

	public static float clamp_float(float num, float min, float max) { return MeowMath.clamp(num, min, max); }

	public static double clamp_double(double num, double min, double max) { return MeowMath.clamp(num, min, max); }
	 ...
	 */
	public static int bucketInt(int p_76137_0_, int p_76137_1_) { return p_76137_0_ < 0 ? -((-p_76137_0_ - 1) / p_76137_1_) - 1 : p_76137_0_ / p_76137_1_; }
	...
	public static boolean epsilonEquals(float p_180185_0_, float p_180185_1_) { return abs(p_180185_1_ - p_180185_0_) < 1.0E-5F; }

	public static int normalizeAngle(int p_180184_0_, int p_180184_1_) { return (p_180184_0_ % p_180184_1_ + p_180184_1_) % p_180184_1_; }
	 ...
	 */
	public static int parseIntWithDefaultAndMax(String p_82714_0_, int p_82714_1_, int p_82714_2_) { return Math.max(p_82714_2_, parseIntWithDefault(p_82714_0_, p_82714_1_)); }
	...
	/**
	 * Uses a B(2, 5) De Bruijn sequence and a lookup table to efficiently calculate the log-base-two of the given value. Optimized for cases where the input value is a
	 * power-of-two. If the input value is not a power-of-two, then subtract 1 from the return value.
	 */
	...
	/**
	 * Efficiently calculates the floor of the base-2 log of an integer value. This is effectively the index of the highest bit that is set. For example, if the number in binary
	 * is 0...100101, this will return 5.
	 */
	public static int calculateLogBaseTwo(int value) { return calculateLogBaseTwoDeBruijn(value) - (isPowerOfTwo(value) ? 0 : 1); }
	...
	public static double func_181162_h(double p_181162_0_) { return p_181162_0_ - Math.floor(p_181162_0_); }

	public static long getPositionRandom(Vec3i pos) { return getCoordinateRandom(pos.getX(), pos.getY(), pos.getZ()); }
	...
	public static double func_181160_c(double p_181160_0_, double p_181160_2_, double p_181160_4_) { return (p_181160_0_ - p_181160_2_) / (p_181160_4_ - p_181160_2_); }
	...
	static {
		...
		for (int j = 0; j < SIN_TABLE_FAST.length; ++j) { SIN_TABLE_FAST[j] = MathUtils.roundToFloat(Math.sin((double) j * Math.PI * 2.0D / 4096.0D)); }
		multiplyDeBruijnBitPosition = new int[] { 0, 1, 28, 2, 29, 14, 24, 3, 30, 22, 20, 15, 25, 17, 4, 8, 31, 27, 13, 23, 21, 19, 16, 7, 26, 12, 18, 6, 11, 5, 10, 9 };
		field_181163_d = Double.longBitsToDouble(4805340802404319232L);
		field_181164_e = new double[257];
		field_181165_f = new double[257];
		for (int k = 0; k < 257; ++k) { double d0 = (double) k / 256.0D; double d1 = Math.asin(d0); field_181165_f[k] = Math.cos(d1); field_181164_e[k] = d1; }
	}
}
