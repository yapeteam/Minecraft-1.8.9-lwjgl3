...
public class EntityMinecartTNT extends EntityMinecart {
   ...
   public EnumMinecartType getMinecartType() { return EnumMinecartType.TNT; }

   public IBlockState getDefaultDisplayTile() { return Blocks.tnt.getDefaultState(); }
   ...
   public void onUpdate() {
	  ...
	  if (this.minecartTNTFuse > 0) {
		 ...
		 this.worldObj.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D,
			   0.0D, new int[0]);
	  }
   ...
   protected void explodeCart(double p_94103_1_) {
	  if (!this.worldObj.isRemote) {
		 double d0 = MeowMath.sqrt(p_94103_1_);
		 if (d0 > 5.0D) {
			d0 = 5.0D;
		 }
    ...
    */
   public int getFuseTicks() { return this.minecartTNTFuse; }

   /**
    * Returns true if the TNT minecart is ignited.
    */
   public boolean isIgnited() { return this.minecartTNTFuse > -1; }
