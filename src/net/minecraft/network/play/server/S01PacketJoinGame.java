...
public class S01PacketJoinGame implements Packet<INetHandlerPlayClient> {
    ...
    */
   public void processPacket(INetHandlerPlayClient handler) { handler.handleJoinGame(this); }

   public int getEntityId() { return this.entityId; }

   public boolean isHardcoreMode() { return this.hardcoreMode; }
