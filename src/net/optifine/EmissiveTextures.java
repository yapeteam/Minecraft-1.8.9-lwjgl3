...
public class EmissiveTextures {
	...
	public static String getSuffixEmissive() { return suffixEmissive; }
	...
	public static ITextureObject getEmissiveTexture(final ITextureObject texture, final Map<ResourceLocation, ITextureObject> mapTextures) {
		if (!render || !(texture instanceof SimpleTexture)) {
			return texture;
		} else {
	...
	public static boolean hasEmissive() { return hasEmissive; }
	...
	private static void dbg(final String str) { Config.dbg("EmissiveTextures: " + str); }

	public static boolean isEmissive(final ResourceLocation loc) { return suffixEmissivePng == null ? false : loc.getResourcePath().endsWith(suffixEmissivePng); }
