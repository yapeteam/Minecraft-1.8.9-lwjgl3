...
public class ShadersRender {
	...
	public static void setFrustrumPosition(ICamera frustum, double x, double y, double z) { frustum.setPosition(x, y, z); }
	...
	public static void beaconBeamBegin() { Shaders.useProgram(Shaders.ProgramBeaconBeam); }
	...
	public static void beaconBeamDraw2() { GlStateManager.disableBlend(); }

	public static void renderEnchantedGlintBegin() { Shaders.useProgram(Shaders.ProgramArmorGlint); }
