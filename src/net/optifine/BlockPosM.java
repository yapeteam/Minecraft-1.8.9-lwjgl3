...
public class BlockPosM extends BlockPos {
	 ...
	 */
	@Override
	public int getZ() { return this.mz; }
	...
	public void setXyz(final double xIn, final double yIn, final double zIn) { this.setXyz(MathHelper.floor_double(xIn), MathHelper.floor_double(yIn), MathHelper.floor_double(zIn)); }
	...
	public BlockPos offsetMutable(final EnumFacing facing) { return this.offset(facing); }
	...
	public BlockPos offset(final EnumFacing facing) {
		if (this.level <= 0) return super.offset(facing, 1);
		else {
			if (this.facings == null) this.facings = new BlockPosM[EnumFacing.VALUES.length];
	 ...
	 */
	@Override
	public BlockPos offset(final EnumFacing facing, final int n) { return n == 1 ? this.offset(facing) : super.offset(facing, n); }
	...
	public BlockPos toImmutable() { return new BlockPos(this.mx, this.my, this.mz); }
	...
	public static Iterable getAllInBoxMutable(final BlockPos from, final BlockPos to) {
		...
		return () -> new AbstractIterator() {
			...
			protected BlockPosM computeNext0() {
				...
				} else if (this.theBlockPosM.equals(blockpos1)) return (BlockPosM) this.endOfData();
				else {
			...
			@Override
			protected Object computeNext() { return this.computeNext0(); }
		};
	}
}
