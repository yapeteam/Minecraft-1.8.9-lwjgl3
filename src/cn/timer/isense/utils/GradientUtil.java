...
public class GradientUtil {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("iSense/Shaders/gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("iSense/Shaders/gradient.frag");
