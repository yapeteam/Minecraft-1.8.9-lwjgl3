...
import cn.timer.isense.utils.color.ColorUtil;
...
public class RoundedUtil {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("iSense/Shaders/roundRectOutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("iSense/Shaders/roundRectTextured.frag");
